...
VALUES 
    (
        ...
        "Slider", 
        .2, 
        "Marketing Automation: Adding automation is vital to transform and streamline your sales and marketing processes. To maximize your business benefit from marketing automation, it\'s important to make sure you take a holistic view and transform all of your old processes, including manual processes around email and campaign management to automating lead flow.",
    ...
    (
        ...
        "Vertfc", 
        .2, 
        "Blueprints, Templates, and More: We encourage you to take advantage of your entire Marketing Automation platform. This helps save time and money and will be key to your success. Templates, campaign blueprints, webforms, and landing pages deliver results immediately in the form of improved marketing scale, efficiency, and brand experience.",
    ...
    (
        ...
        NULL, 
        .1, 
        "Campaign automation: Automating campaigns can greatly increase efficiency. An \"always on\" nurture campaign allows you to engage prospects who have signalled their interest. It allows you to intelligently add them into an adaptive nurture campaign and keep them engaged at just the right level.",
        "It's great to see you have taken the next step in automation - specifically to use \"always on\" nurture campaigns.", 
        "Responsive",
        "Campaign Automation"
    ),
    (
    ...
    (
        ...
        NULL, 
        .1, 
        "Behavioral Re-Targeting: In the Experience Economy, the customer journey is no longer linear and marketers have only micro-moments in which to engage buyers. The speed at which you can target and engage with accurate data will determine your ultimate success at buyer acquisition through close of sale. ",
    ...
    (
        ...
        "Do you currently use testing and optimization tools on your landing pages and website? 
            ...
            c. Yes, we use A/B, multivariate testing and optimization tools regularly", 
        NULL, 
        .1, 
    ...
    (
        ...
        "Do you have data connections that allow you to have a full 360 degree view of your customer across marketing, sales, and service?
            ...
            c. Yes! We have connections for all three. 
    ...
    (
        ...
        "Do you run marketing programs to drive sales on a B2B commerce site for repeat or low-consideration purchases?
            ...
            c. Yes, our commerce site has been integrated into our overall marketing strategy",
        NULL, 
        .125, 
