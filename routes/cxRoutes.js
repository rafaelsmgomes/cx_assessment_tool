...
router.get('/', renderTool);
router.get('/htmlversion/:id', createHTMLversion);
router.post('/api', generateData); 
router.get('/api2/:id', getOverallResults);
router.get('/pdfdata/:id', sendDataToPDF);
